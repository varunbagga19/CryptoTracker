...
class DeveloperPreview{
    ...
    let state1 = StatisticModel(title: "Market Cap", value: "$12.58Bn",percentageChange: 25.34)
    let state2 = StatisticModel(title: "TotalVolume", value: "$12.2tr")
    let state3 = StatisticModel(title: "PortFolio Value", value: "$12.58Bn",percentageChange: -25.34)
